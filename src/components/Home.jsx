  ...
  return (
    <group>
      ...
      <Html 
       ...
       >
        <div>
        <div className='flex text-[80px] items-center justify-center gap-5'>
            <h1>We Create,</h1>
            {/* <img src={Icon} alt='icon-arrow'/> */}
        </div>
        <div className='flex text-[80px] items-center justify-center gap-5'>
            <h1 className="">We</h1>
            {/* <img className='rotate-180' src={Icon} alt='icon-arrow'/> */}
            <h1 className="bg-gradient-to-r from-[#F68A44] to-[#EC500B] bg-clip-text text-transparent"><span>Build.</span></h1>
        </div>
        <p className='text-[24px] text-center font-light text-[#C2C2C2]'>
